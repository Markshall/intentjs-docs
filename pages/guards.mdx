...
They have access to the instance of [`Reflector`](/reflection) which lets you access the metadata and perform logic in your guard accordingly.
...
3. `Reflector` - the Reflector class, read more about it [here](/reflections)
...
You can read more about `Reflector` class [here](/reflections).
