...
import { MailerOptions, IntentMail } from '@intentjs/core';
...
### Sendgrid
To configure sendgrid as a provider in your application, you can do so by

<Callout type="info">
You can get the sendgrid's api key from it's console.
</Callout>
...
![In-built template sample](/docs/email-sample-light.png)
...
![In-built template sample](/docs/email-sample-dark.png)
...
![Email Code Snippet Sample](/docs/mail-code-snippet.png)
...
```typescript
mail.attach("license", {
  path: "https://link.com/invoice.pdf",
});
```
