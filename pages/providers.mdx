...
Apart from creating simple providers, you can also create your own custom providers using Intent. To do so, you can use class, value, some factory method, etc.
To see how to build your own custom provider in Intent, we recommend reading through [`Service Provider`](/service-providers) documentation.
